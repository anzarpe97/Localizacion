...
class accessAccessManagement(models.Model):
    ...
    def access_compute_profile_ids(self):
        ...
        for rec in self:
            ...
            rec.access_profile_domain_model = [(6, 0, model_ids)]
